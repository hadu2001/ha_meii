...
const propose = () => {
    ...
    // Play love-story.mp3 concurrently
    const hataAudio = new Audio("../assets/nhac/love-story.mp3");
    hataAudio.play().catch(error => console.error("Love Story audio playback failed:", error));
};
